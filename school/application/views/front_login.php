...
<html>
    ...
    <body class="hold-transition login-page">
        <h1><center>Frontpage Login</center></h1>
        <div class="login-box">
...
?>                                
                                ...
                                <option value="8">Transporter</option>
...
?>                                
                    ...
                    <div class="form-group has-feedback">
                        <input required type="email" name="user_email" id="user_email" class="form-control" placeholder="Email">
                        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
                    </div>
                    
                    <div class="form-group has-feedback">
                        <input required type="password" name="user_password" id="user_password" class="form-control" placeholder="Password">
                        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                        
                        <input type="hidden" name="user_role_name" id="user_role_name">
                        <input type="hidden" name="user_role_numeric" id="user_role_numeric">                        
                    </div>
                    ...
                    <div class="row">
                        ...
                        <!-- /.col -->
                        <div class="col-xs-4">
                               <input id="submit" type="submit" name="submit" value="Submit" class="btn btn-primary btn-block btn-flat">
                        </div>
                        <!-- /.col -->
                    </div>
                </form>
