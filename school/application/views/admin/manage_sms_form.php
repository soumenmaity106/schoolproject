...
<hr>
<div>
<center><h3>Manage SMS(s)</h3></center>
<a style="margin-left:10px;" href="<?php echo base_url()?>Super_admin/add_sms">
...
<tbody>
    <?php
    foreach ($all_sms as $v_all_student) {
        ?>        
        <tr>
            <!--<div style="height:15px; min-height:15px; overflow :auto;">-->
    <div>             
        <td id="td1"><?php echo $v_all_student->sms_id; ?></td>
        <td class="chotafont"><?php echo $v_all_student->to_phone; ?></td>
        <td class="chotafont"><?php echo $v_all_student->message; ?></td>
        <td class="chotafont"><?php echo $v_all_student->user_role_name; ?></td>
