...
<hr>
<div>
<center><h3>Exam Question Instruction Management</h3></center>
<a style="margin-left:10px;" href="<?php echo base_url()?>Super_admin/add_exam_question_instruction">
...
<tbody>
    <?php
    foreach ($all_question_instruction as $v_all_student) {
        ?>        
        <tr>
            <!--<div style="height:15px; min-height:15px; overflow :auto;">-->
    <div>             
        <td id="td1"><?php echo $v_all_student->q_instruct_id; ?></td>
        <td id="td2"><?php echo $v_all_student->title; ?></td>
        <td id="td1"><?php echo $v_all_student->content; ?></td>
