...
<hr>
<div>
<center><h3>Books Category Management</h3></center>
<a style="margin-left:10px;" href="<?php echo base_url()?>Super_admin/add_books_category">
...
<tbody>
    <?php
    foreach ($all_books_category as $v_all_student) {
        ?>        
        <tr>
            <!--<div style="height:15px; min-height:15px; overflow :auto;">-->
    <div>             
        <td id="td1"><?php echo $v_all_student->category_id; ?></td>
        <td id="td2"><?php echo $v_all_student->category_name; ?></td>
        <td id="td1"><?php echo $v_all_student->category_description; ?></td>
        <td id="td2"><?php echo $v_all_student->publication_status; ?></td>
