...
<hr>
<center><h3>Transport Management</h3></center>
<a style="margin-left:10px;" href="<?php echo base_url()?>Super_admin/add_transport">
...
<tbody>
    <?php
    foreach ($all_transport as $v_all_teacher) {
        ?>        
        <tr>
            <!--<div style="height:15px; min-height:15px; overflow :auto;">-->
    <div>             
        <td id="td1"><?php echo $v_all_teacher->transport_id; ?></td>
        <td id="td2"><?php echo $v_all_teacher->transport_route_name; ?></td>
        <td id="td2"><?php echo $v_all_teacher->transport_no_of_vehicle; ?></td>
        <td id="td2"><?php echo $v_all_teacher->transport_route_fare; ?></td>
        <td id="td2"><?php echo $v_all_teacher->transport_note; ?></td>
