...
<hr>
<div>
<center><h3>Visitor Management</h3></center>
<a style="margin-left:10px;" href="<?php echo base_url()?>Super_admin/add_visitor">
...
<table id="management-table" class="table table-bordered">
...
<tbody>
    <?php
    foreach ($all_visitor as $v_all_student) {
        ?>        
    <tr>
            <!--<div style="height:15px; min-height:15px; overflow :auto;">-->
    <div>             
        <td id="td1"><?php echo $v_all_student->visitor_id; ?></td>
        <td id="td3"><?php echo substr($v_all_student->visitor_name, 0, 50);?></td>
        <td id="td3"><?php echo substr($v_all_student->visitor_tomeet, 0, 50);?></td>
        <td id="td3"><?php echo substr($v_all_student->visitor_checkin, 0, 50);?></td>
        <td id="td3"><?php echo substr($v_all_student->visitor_checkout, 0, 50);?></td> 
        <td id="td3"><?php echo substr($v_all_student->visitor_status, 0, 50);?></td> 
<!--        
