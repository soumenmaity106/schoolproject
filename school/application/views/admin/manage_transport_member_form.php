...
<hr>
<div>
<center><h3>Transport Member Management</h3></center>
<a style="margin-left:10px;" href="<?php echo base_url()?>Super_admin/add_transport_member">
...
<tbody>
    <?php
    foreach ($all_transport_member as $v_all_student) {
        ?>        
        <tr>
            <!--<div style="height:15px; min-height:15px; overflow :auto;">-->
    <div>             
        <td id="td1"><?php echo $v_all_student->trans_memb_id; ?></td>
        <td id="td2"><?php echo $v_all_student->name; ?></td>
        ...
        <td class="center">
            <a class="wrap_link" href="product.html"> 
                <span class="image">
                    <img style="border-radius:20%; border:2px solid #3C8DBC;" src="<?php echo base_url().$v_all_student->photo;?>" alt="Student_image" height="30" width="30" />
                </span> 
            </a>
        </td>
       ...
       <!-- <a id="popover" data-trigger="hover"> -->
        <td id="td3"><?php echo substr($v_all_student->	roll, 0, 50);?></td>
       <!-- </a> -->
       
       <td id="td3"><?php echo substr($v_all_student->email, 0, 50);?></td>
<!--        
