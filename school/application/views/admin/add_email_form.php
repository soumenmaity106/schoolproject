...
echo $zdate; 
?>            
    <form class="form-horizontal" action="<?php echo base_url();?>super_admin/save_email" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="to">Receiver Email Adresss<span class="req">*</span></label>
                            <input required type="text" class="form-control" name="to" id="to" placeholder="Enter email of Receiver">
                        </div>

                        <div class="form-group">
                            <label for="cc_to">CC To<span class="req">*</span></label>
                            <input type="text" class="form-control" name="cc_to" id="cc_to" placeholder="Enter 2nd Receiver">
                        </div>

                        <div class="form-group">
                            <label for="bcc_to">BCC To<span class="req">*</span></label>
                            <input type="text" class="form-control" name="bcc_to" id="bcc_to" placeholder="Enter 3rd Receiver">
                        </div>
                        
                        
                        <div class="form-group">
                            <label for="student_gurdian">Subject</label>
