...
<section class="content">
    ...
    <form class="form-horizontal" action="<?php echo base_url();?>super_admin/save_transport_member" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            ?>                                
                                <option value="<?php echo $v_student->student_id; ?>">
                                    <?php echo $v_student->student_name; ?>
                                </option>
                            <?php
                            }
                            ?>                                
                        ...
                        <div class="form-group">
                          ...
                          <!--<img id="blah" src="<?php echo base_url();?><?php echo $v_student->student_photo; ?>" alt="your image" />-->
                          </div>
                        </div>                         
                        ...
                        <div class="form-group">
                            <label for="roll">Role Number<span class="req">*</span></label>
                            <input required type="text" class="form-control" name="roll" id="roll" placeholder="Enter Roll No">
                        </div>
