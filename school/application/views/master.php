...
<html lang="en">
    ...
    <!-- Mirrored from trendytheme.net/demo/matrox/seo-index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Mar 2018 13:02:23 GMT -->
    ...
    <head>
        ...
        <meta name="keywords" content="material, seo, corporate, business, parallax, creative, agency">
        <meta name="author" content="trendytheme.net">
        <title>Aapka School|<?php echo $title; ?></title>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 text-right">
                        <ul class="topbar-cta no-margin">
                            <li class="mr-20">
                                <a><i class="material-icons mr-10">&#xE0B9;</i><span class="__cf_email__" data-cfemail="335a5d555c735e524756415a525f5a49561d505c5e">[email&#160;protected]</span></a>
                            </li>
                            <li>
                                <a><i class="material-icons mr-10">&#xE0CD;</i> +01 123 456 78</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url();?>welcome/front_registration" class="btn btn-xs btn-primary">
                                    Registration
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url();?>welcome/front_login" class="btn btn-xs btn-info">
                                    Login
                                </a>  
                            </li>
                        </ul>
            ...
            <div class="header-sticky light-header ">
                <div class="container">
                    ...
                    <div id="materialize-menu" class="menuzord">
                        ...
                        <a href="<?php echo base_url(); ?>welcome/index" class="logo-brand">
                            <img src="<?php echo base_url(); ?>assets/img/seo/logo.png" alt="">
                        </a>
...
<!--                            <li class="active"><a href="<?php echo base_url(); ?>welcome/index">Home</a></li>-->
                            ...
                            <li><a href="<?php echo base_url(); ?>welcome/casestudy">Case Studies</a></li>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <span class="copy-text">Copyright &copy; 2016 <a href="#">Aapk School</a> &nbsp; | &nbsp; All Rights Reserved &nbsp; | &nbsp; Designed By <a href="#">TrendyTheme</a></span>
        ...
        <script data-cfasync="false" src="../../cdn-cgi/scripts/d07b1474/cloudflare-static/email-decode.min.js"></script><script src="assets/js/jquery-2.1.3.min.js"></script>
    ...
    <!-- Mirrored from trendytheme.net/demo/matrox/seo-index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Mar 2018 13:03:21 GMT -->
</html>