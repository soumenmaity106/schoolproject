...
class Super_admin extends CI_Controller {
    ...
    public function xxmanage_parent()
    {
      $data = array();
      ...
      //$this->load->view('admin/admin_master', $data);     
      $this->load->view('admin/manage_parent_form', $data);     
    }
    ...
    public function save_student()
    {
         ...
         //$data['student_class']         = "not req"; // ''$this->input->post('student_name',TRUE);
...
//         exit();
    ...
    public function manage_student()
    {
      ...
      $this->load->view('admin/manage_student_form', $data);
      //$this->load->view('admin/admin_master', $data);     
    }
...
//-----------         
    ...
    public function xmanage_parent2()
    {
      $data = array();
      $data['all_parent'] = $this->sa_model->select_all_parent();                //both published and unpublished 
      $data['ADMINMAINCONTENT'] = $this->load->view('admin/manage_parent_form',$data, TRUE);
...
//    }
    ...
    {
      $this->sa_model->update_suspend_parent_by_id($parent_id);
      redirect('super_admin/manage_parent2');
    }
...
//manage_teacher        
    public function manage_teacher()
    {
      ...
      $this->load->view('admin/manage_teacher_form', $data);     
    }
...
//manage_teacher        
    public function manage_user()
    {
      ...
      //$this->load->view('admin/admin_master', $data);     
      $this->load->view('admin/manage_user_form', $data);     
    }
    
    public function qmanage_parent()
    {
      $data = array();
      $data['all_parent'] = $this->sa_model->select_all_parent();                //both published and unpublished 
      $data['ADMINMAINCONTENT'] = $this->load->view('admin/manage_parent_form',$data, TRUE);
...
//==============                        
    ...
    public function manage_class()
    {
      ...
      //$this->load->view('admin/admin_master', $data);     
      $this->load->view('admin/manage_class_form', $data);     
    }
    ...
    public function manage_subject()
    {
      ...
      //$this->load->view('admin/admin_master', $data);     
      $this->load->view('admin/manage_subject_form', $data);     
    }
    ...
    public function manage_section()
    {
      ...
      //$this->load->view('admin/admin_master', $data);     
      $this->load->view('admin/manage_section_form', $data);     
    }
    ...
    public function manage_syllabus()
    {
      ...
      //$this->load->view('admin/admin_master', $data);     
      $this->load->view('admin/manage_syllabus_form', $data);     
    }
...
//         exit();
    ...
    public function manage_assignment()
    {
      ...
      //$this->load->view('admin/admin_master', $data);     
      $this->load->view('admin/manage_assignment_form', $data);     
    }
...
//         exit();
    ...
    public function manage_routine()
    {
      ...
      //$this->load->view('admin/admin_master', $data);     
      $this->load->view('admin/manage_routine_form', $data);     
    }
...
//save_exam        
    ...
    public function manage_exam()
    {
      ...
      //$this->load->view('admin/admin_master', $data);     
      $this->load->view('admin/manage_exam_form', $data);     
    }
    ...
    public function manage_exam_schedule()
    {
      ...
      //$this->load->view('admin/admin_master', $data);     
      $this->load->view('admin/manage_exam_schedule_form', $data);     
    }
...
//manage_exam_grade        
    public function manage_exam_grade()
    {
      ...
      //$this->load->view('admin/admin_master', $data);     
      $this->load->view('admin/manage_exam_grade_form', $data);     
    }
    ...
    public function manage_exam_attendence()
    {
      ...
      //$this->load->view('admin/admin_master', $data);     
      $this->load->view('admin/manage_exam_attendence_form', $data);     
    }
...
//manage_staff
    public function manage_staff()
    {
      ...
      //$this->load->view('admin/admin_master', $data);     
      $this->load->view('admin/manage_staff_form', $data);     
    }
...
//$message .= '</body></html>';			
    ...
    public function start_student_attendence()
    {
     ...
     $data['class_id']         = $this->input->post('class_id',TRUE);
     $data['section_id']       = $this->input->post('section_id',TRUE);        
     $data['attendence_class'] = $this->sa_model->select_attendence_class($data['class_id'], $data['section_id']); 
     ...
     //$data['ADMINMAINCONTENT'] = $this->load->view('admin/manage_student_attendence_start', $data, TRUE);
     $data['ADMINMAINCONTENT'] = $this->load->view('admin/manage_student_attendence_form', $data, TRUE);
     $this->load->view('admin/admin_master', $data);   
    }

    public function student_mark_attendence($student_id){
