...
class Student_ci extends CI_Controller {
    ...
    public function __construct() 
    {
        ...
        if($admin_id == NULL)
          ...
          $this->load->model('Student_model','st_model');  // name_of_model, object_of_that_model
          //$this->load->model('Super_Admin_Model','sa_model');  // name_of_model, object_of_that_model
    }
...
//$message .= '</body></html>';			
    ...
    public function xstart_student_attendence()
    {
     ...
     $data['attendence_class'] = $this->st_model->select_attendence_class($zclass, $zsection); 
     $data['ADMINMAINCONTENT'] = $this->load->view('admin/add_student_form', $data, TRUE);
     $this->load->view('admin/admin_master', $data);   
    }
